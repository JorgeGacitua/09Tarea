...
v_rec = np.loadtxt('data/hubble_original.dat', usecols=[1])
d = np.loadtxt('data/hubble_original.dat', usecols=[0])
...
plt.savefig("hubble_original_histograma.eps")
plt.show()
plt.draw()
print "Intervalo de confianza al 95%: [{}:{}]".format(limite_bajo, limite_alto)
print "H0={}".format(h0)
